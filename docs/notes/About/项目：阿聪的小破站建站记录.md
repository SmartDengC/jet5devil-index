...
访问主页的时候，发现原来用的网站的 ssl 证书过期了， https://bing.img.run/rand_uhd.php，等后期更新。

另外找到一个 github 仓库 [flow2000/bing-wallpaper-api](https://github.com/flow2000/bing-wallpaper-api)，使用的连接为：https://api.bimg.cc/random?w=1920&h=1080&mkt=zh-CN
