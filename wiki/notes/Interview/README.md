...
pageLayout: home
title: 面试题
createTime: 2025/07/16 20:07:52
icon: /images/memorandum.svg
permalink: /interview/
pageClass: page-backend-interview
config:
  - type: doc-hero
    hero:
      name: 面试题
      tagline: 记录自己学习知识点的过程，主要一后端面试题为主，以面试的口吻记录，主要起一个留痕的作用。
      image:
        src: /images/memorandum.svg
        width: 128
        height: 128
      actions:
        - text: 开始学习 →
...
[data-theme="dark"] .page-backend-interview {
  --vp-home-hero-image-background-image: linear-gradient(
    45deg,
