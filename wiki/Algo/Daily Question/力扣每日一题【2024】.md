...
### 1281. [整数的各位积和之差](https://leetcode.cn/problems/subtract-the-product-and-sum-of-digits-of-an-integer/) （20241216）
...
### [231. 2 的幂](https://leetcode.cn/problems/power-of-two/)（20241217）

学习幂运算的话，可以看看下面这篇文章：[常用的位操作](https://labuladong.online/algo/frequency-interview/bitwise-operation/)
...
### [326. 3 的幂](https://leetcode.cn/problems/power-of-three/)（20241217）

今天多做几道题。学习关于丑数的内容，可以参考如下文章： [一文秒杀所有丑数系列问题](https://labuladong.online/algo/frequency-interview/ugly-number-summary/)
...
### [263. 丑数](https://leetcode.cn/problems/ugly-number/)（20241217）
...
### [1470. 重新排列数组](https://leetcode.cn/problems/shuffle-the-array/)（20241217）
...
![image-20241217174335773](https://gitee.com/jet5devil/typora-picture/raw/master/mac_img/202412171743887.png)
...
### [867. 转置矩阵](https://leetcode.cn/problems/transpose-matrix/) （20241217）
...
### [1422. 分割字符串的最大得分](https://leetcode.cn/problems/maximum-score-after-splitting-a-string/)（20241218）
...
### [2586. 统计范围内的元音字符串数](https://leetcode.cn/problems/count-the-number-of-vowel-strings-in-range/)（20241218）
...
### [852. 山脉数组的峰顶索引](https://leetcode.cn/problems/peak-index-in-a-mountain-array/)（20241218）
...
题目中`num1[i]`可以被`num2[j]*k`整除， 除法是被除数/除数， 所以翻译过来如下：
$$
\frac{num2[j] * k}{num1[i]}
$$
这是简单题，可以直接暴力两次循环，然后判断`num2[j] * k `除以`num1[i]`余数是非为0，来判断是否是优质对。

[3164. 优质数对的总数 II](https://leetcode.cn/problems/find-the-number-of-good-pairs-ii/)，这个题难度就升级了， 直接看灵神的题解。

@[bilibili](BV17t421N7L6) 
